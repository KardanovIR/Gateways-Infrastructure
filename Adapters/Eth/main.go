...
import (
	...
	"github.com/Waves/GatewaysInfrastructure/Adapters/Eth/config"
	"github.com/Waves/GatewaysInfrastructure/Adapters/Eth/server"
...
func main() {
	...
	if err := server.InitAndStart(config.Cfg.Port, services.GetNodeClient()); err != nil {
