...
type GetBalanceIncludedTokensRequest struct {
	Address              string   `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
...
func (m *GetBalanceIncludedTokensRequest) Reset()         { *m = GetBalanceIncludedTokensRequest{} }
func (m *GetBalanceIncludedTokensRequest) String() string { return proto.CompactTextString(m) }
func (*GetBalanceIncludedTokensRequest) ProtoMessage()    {}
func (*GetBalanceIncludedTokensRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_1a3043ca784e1536, []int{14}
}

func (m *GetBalanceIncludedTokensRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetBalanceIncludedTokensRequest.Unmarshal(m, b)
}
func (m *GetBalanceIncludedTokensRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetBalanceIncludedTokensRequest.Marshal(b, m, deterministic)
}
func (m *GetBalanceIncludedTokensRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetBalanceIncludedTokensRequest.Merge(m, src)
}
func (m *GetBalanceIncludedTokensRequest) XXX_Size() int {
	return xxx_messageInfo_GetBalanceIncludedTokensRequest.Size(m)
}
func (m *GetBalanceIncludedTokensRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetBalanceIncludedTokensRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetBalanceIncludedTokensRequest proto.InternalMessageInfo

func (m *GetBalanceIncludedTokensRequest) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *GetBalanceIncludedTokensRequest) GetContracts() []string {
	if m != nil {
		return m.Contracts
	}
	return nil
...
type GetBalanceIncludedTokensReply struct {
	Amount               string                                        `protobuf:"bytes,1,opt,name=amount,proto3" json:"amount,omitempty"`
	TokenBalances        []*GetBalanceIncludedTokensReply_TokenBalance `protobuf:"bytes,2,rep,name=token_balances,json=tokenBalances,proto3" json:"token_balances,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                      `json:"-"`
	XXX_unrecognized     []byte                                        `json:"-"`
	XXX_sizecache        int32                                         `json:"-"`
}

func (m *GetBalanceIncludedTokensReply) Reset()         { *m = GetBalanceIncludedTokensReply{} }
func (m *GetBalanceIncludedTokensReply) String() string { return proto.CompactTextString(m) }
func (*GetBalanceIncludedTokensReply) ProtoMessage()    {}
func (*GetBalanceIncludedTokensReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_1a3043ca784e1536, []int{20}
}

func (m *GetBalanceIncludedTokensReply) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetBalanceIncludedTokensReply.Unmarshal(m, b)
}
func (m *GetBalanceIncludedTokensReply) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetBalanceIncludedTokensReply.Marshal(b, m, deterministic)
}
func (m *GetBalanceIncludedTokensReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetBalanceIncludedTokensReply.Merge(m, src)
}
func (m *GetBalanceIncludedTokensReply) XXX_Size() int {
	return xxx_messageInfo_GetBalanceIncludedTokensReply.Size(m)
}
func (m *GetBalanceIncludedTokensReply) XXX_DiscardUnknown() {
	xxx_messageInfo_GetBalanceIncludedTokensReply.DiscardUnknown(m)
}

var xxx_messageInfo_GetBalanceIncludedTokensReply proto.InternalMessageInfo

func (m *GetBalanceIncludedTokensReply) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
func (m *GetBalanceIncludedTokensReply) GetTokenBalances() []*GetBalanceIncludedTokensReply_TokenBalance {
	if m != nil {
...
type GetBalanceIncludedTokensReply_TokenBalance struct {
...
func (m *GetBalanceIncludedTokensReply_TokenBalance) Reset() {
	*m = GetBalanceIncludedTokensReply_TokenBalance{}
}
func (m *GetBalanceIncludedTokensReply_TokenBalance) String() string {
	return proto.CompactTextString(m)
}
func (*GetBalanceIncludedTokensReply_TokenBalance) ProtoMessage() {}
func (*GetBalanceIncludedTokensReply_TokenBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_1a3043ca784e1536, []int{20, 0}
}

func (m *GetBalanceIncludedTokensReply_TokenBalance) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetBalanceIncludedTokensReply_TokenBalance.Unmarshal(m, b)
}
func (m *GetBalanceIncludedTokensReply_TokenBalance) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetBalanceIncludedTokensReply_TokenBalance.Marshal(b, m, deterministic)
}
func (m *GetBalanceIncludedTokensReply_TokenBalance) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetBalanceIncludedTokensReply_TokenBalance.Merge(m, src)
}
func (m *GetBalanceIncludedTokensReply_TokenBalance) XXX_Size() int {
	return xxx_messageInfo_GetBalanceIncludedTokensReply_TokenBalance.Size(m)
}
func (m *GetBalanceIncludedTokensReply_TokenBalance) XXX_DiscardUnknown() {
	xxx_messageInfo_GetBalanceIncludedTokensReply_TokenBalance.DiscardUnknown(m)
}

var xxx_messageInfo_GetBalanceIncludedTokensReply_TokenBalance proto.InternalMessageInfo

func (m *GetBalanceIncludedTokensReply_TokenBalance) GetContract() string {
	if m != nil {
		return m.Contract
	}
	return ""
...
func (m *GetBalanceIncludedTokensReply_TokenBalance) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*GetBalanceIncludedTokensRequest)(nil), "ethAdapter.GetBalanceIncludedTokensRequest")
	...
	proto.RegisterType((*GetBalanceIncludedTokensReply)(nil), "ethAdapter.GetBalanceIncludedTokensReply")
	proto.RegisterType((*GetBalanceIncludedTokensReply_TokenBalance)(nil), "ethAdapter.GetBalanceIncludedTokensReply.TokenBalance")
}
...
var fileDescriptor_1a3043ca784e1536 = []byte{
	...
	,
}
...
type CommonClient interface {
	...
	// Get account's balance and balances of requested tokens
	GetBalanceIncludedTokens(ctx context.Context, in *GetBalanceIncludedTokensRequest, opts ...grpc.CallOption) (*GetBalanceIncludedTokensReply, error)
	// Generate address
...
func (c *commonClient) GetBalanceIncludedTokens(ctx context.Context, in *GetBalanceIncludedTokensRequest, opts ...grpc.CallOption) (*GetBalanceIncludedTokensReply, error) {
	out := new(GetBalanceIncludedTokensReply)
	err := c.cc.Invoke(ctx, "/ethAdapter.Common/GetBalanceIncludedTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommonServer interface {
	...
	// Get account's balance and balances of requested tokens
	GetBalanceIncludedTokens(context.Context, *GetBalanceIncludedTokensRequest) (*GetBalanceIncludedTokensReply, error)
	// Generate address
...
func _Common_GetBalanceIncludedTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBalanceIncludedTokensRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommonServer).GetBalanceIncludedTokens(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ethAdapter.Common/GetBalanceIncludedTokens",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommonServer).GetBalanceIncludedTokens(ctx, req.(*GetBalanceIncludedTokensRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Common_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBalanceIncludedTokens",
			Handler:    _Common_GetBalanceIncludedTokens_Handler,
		},
		{
