...
var fileDescriptor_51c84a83e429816a = []byte{
	...
	,
}
...
type CoreServiceClient interface {
	InitInTx(ctx context.Context, in *TxRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *coreServiceClient) InitInTx(ctx context.Context, in *TxRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type CoreServiceServer interface {
	InitInTx(context.Context, *TxRequest) (*Empty, error)
...
func _CoreService_InitInTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServiceServer).InitInTx(ctx, req.(*TxRequest))
	}
